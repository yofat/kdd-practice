...
from sklearn.metrics import accuracy_score, classification_report, ConfusionMatrixDisplay, confusion_matrix, zero_one_loss
...
""" The time difference is : 3.8621749
