...
def mlp_clf():
    ...
    y_pred = clf_nn.predict(test_x)
    cm = confusion_matrix(test_Y, y_pred)
    disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=clf_nn.classes_)
...
""" The time difference is : 342.8299513
