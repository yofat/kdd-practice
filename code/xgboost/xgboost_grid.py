...
def xgboost_grid_search():
    ...
    grid_params = {"learning_rate": [0.05, 0.10, 0.2, 0.3],"max_depth": [3, 4, 5, 6, 8, 10, 12, 15],"n_estimators": [50, 100, 200, 250, 500]}
    ...
    grid_object.fit(train_x, encoded_train_Y)
