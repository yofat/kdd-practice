...
## 結果比書中作者 0.237979063165 還低 -> 0.2378903477643719

""" import seaborn as sns

plt.figure(figsize=(8, 6))

sns.heatmap(results, annot=True, fmt="d", cmap="Blues", linewidths=.5)
...
#print(train_Y.value_counts().apply(lambda x: x/float(len(train_Y))))
...
print(error)
 """
### 比作者的0.223962029808 差(也比原本差) -> 0.25851667849538684
""" [[8936   85  678    6    6]
 [1357 5418  861    0    0]
 [ 137  172 2113    0    1]
 [2236    0   98  212   28]
...
""" Completeness: 0.49513890860174614
Homogeneity: 0.4082713592099232
V-measure: 0.4475287528051309 """