...
plt.subplot(2, 2, 1)
train_attack_types.plot(kind='barh', fontsize=12)
plt.title('Train Attack Types Distribution')

plt.subplot(2, 2, 2)
train_attack_cats.plot(kind='barh', fontsize=12)
plt.title('Train Attack Categories Distribution')

plt.subplot(2, 2, 3)
test_attack_types.plot(kind='barh', fontsize=12)
plt.title('Test Attack Types Distribution')

plt.subplot(2, 2, 4)
test_attack_cats.plot(kind='barh', fontsize=12)
plt.title('Test Attack Categories Distribution')
